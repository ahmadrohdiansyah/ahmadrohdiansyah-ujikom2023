<?php 
	...
	elseif($_SESSION['data']['level'] != "masyarakat"){
		header('location:../index.php');
	}
 ?>
<!DOCTYPE html>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="membuat_laporan.php">Home <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
      ...
      <!-- <Kode untuk membuat berita berjalan :o> -->
        <div class="container">
          <div class="carousel-caption text-left">
            ...
            <p>Website Pengaduan Masyarakat ini dibuat dengan tujuan sebagai ujian praktek SMK Jurusan Rekayasa Perangkat Lunak</p>
